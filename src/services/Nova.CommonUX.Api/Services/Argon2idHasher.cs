...
/// <summary>
/// Argon2id password/secret hashing and verification using Konscious.
...
internal static class Argon2idHasher
{
    ...
    /// <summary>
    /// Hashes <paramref name="plaintext"/> with a random salt and returns the encoded hash string.
    /// Suitable for storing in <c>tenant_secrets.client_secret_hash</c> and
    /// <c>tenant_user_auth.password_hash</c>.
    /// </summary>
    ...
    /// <summary>
    /// Returns <c>true</c> if <paramref name="plaintext"/> matches <paramref name="storedHash"/>.
