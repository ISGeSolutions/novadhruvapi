...
/// API key is stored CipherService-encrypted in <c>appsettings.json → Email.SendGrid.ApiKey</c>.
/// Sender address and display name are in <c>opsettings.json → Email.SendGrid</c>.
/// </summary>
